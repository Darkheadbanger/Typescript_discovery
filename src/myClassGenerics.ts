...
let numbersGenericsClass = new DataContainer<number>([1, 2, 3, 4]);
let stringsGenericsClass = new DataContainer<string>(["a", "b", "c", "d"]);
...
let stringValidator = new Validator<string>();
let numberValidator = new Validator<number>();
let objectValidator = new Validator<{ prop1: string; prop2: number }>();
