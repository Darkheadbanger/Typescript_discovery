...
abstract class TakePhoto {
  constructor(public cameraModel: string, public filter: string) {}
...
class DigitalItem extends Item {
  constructor(id: number, name: string, price: number, dwonload_URL: string) {
    super(id, name, price);
  }
...
const digitalItems = new DigitalItem(
  1,
  "Film Avatar",
  10,
  "https://www.youtube.com/watch?v=kbI644DN4Dc"
);
